USE [master]
GO
/****** Object:  Database [BookStoresDB]    Script Date: 21-09-2025 13:45:55 ******/
CREATE DATABASE [BookStoresDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BookStoresDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\BookStoresDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BookStoresDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\BookStoresDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [BookStoresDB] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [BookStoresDB] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [BookStoresDB] SET QUERY_STORE = OFF
GO
USE [BookStoresDB]
GO
/****** Object:  UserDefinedDataType [dbo].[empid]    Script Date: 21-09-2025 13:45:55 ******/
CREATE TYPE [dbo].[empid] FROM [char](9) NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[id]    Script Date: 21-09-2025 13:45:55 ******/
CREATE TYPE [dbo].[id] FROM [varchar](11) NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[tid]    Script Date: 21-09-2025 13:45:55 ******/
CREATE TYPE [dbo].[tid] FROM [varchar](6) NOT NULL
GO
/****** Object:  Table [dbo].[Author]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Book]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[BookAuthor]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Job]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Publisher]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RefreshToken]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Role]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sale]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Store]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 21-09-2025 13:45:55 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [PK_user_id_2]    Script Date: 21-09-2025 13:45:55 ******/
